	...
	try {
		...
		Context.pipeline = new PipelineController({
			...
			PIPELINE_SKIP_UPDATE_METADATA_PRESENT_FILES:
				environment.PIPELINE_SKIP_VERIFY_PRESENT_FILES,
			PIPELINE_SKIP_DOWNLOADS: environment.PIPELINE_SKIP_VERIFY_PRESENT_FILES,
			PIPELINE_SKIP_POSTERS: environment.PIPELINE_SKIP_VERIFY_PRESENT_FILES,
			PIPELINE_INCLUDE_SPECIALS: environment.PIPELINE_SKIP_VERIFY_PRESENT_FILES,
			PIPELINE_PREFER_EXTENDED: environment.PIPELINE_SKIP_VERIFY_PRESENT_FILES,
			PIPELINE_PREFER_G8: environment.PIPELINE_SKIP_VERIFY_PRESENT_FILES,
		})
